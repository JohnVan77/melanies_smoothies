...
st.write("The name on the Smoohtie will be:", name_on_order)
...
#st.write("Your favuorite fruit is:", option)
...
if ingredients_list:  # Cleaning Up Empty Brackets
    ...
    #st.stop()  # stop() command can be used for troubleshooting
